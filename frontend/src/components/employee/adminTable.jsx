        ...
        <div className="h-full flex flex-col items-center pt-6">
            <div className="w-4/5 max-w-4x1">
                <div className="bg-primary py-3 text-white px-4 relative">
                    ...
                    <button onClick={handleAdd} className="text-sm bg-sky-800 text-white px-4 py-1 rounded hover:bg-blue-100 hover:text-primary absolute right-10 top-1/2 transform -translate-y-1/2"><span>Add</span></button>
                </div>
